...
from predictor import DENetPredictor
...
class DENet(object):
    def __init__(self,
                 ...
                 fasta=None,
                 comutation=None,
                 use_loc_feat=True, use_glob_feat=True, use_gcn=True,
                 c_map=None, split_ratio=[0.9, 0.1],
                 nn_name='lstm',
                 random_seed=42,
                 n_ensembles=1,
                 d_embed=20, d_model=256, d_h=32, d_out=256,
                 nlayers=1, 
        ...
        self.models = [DENetPredictor(
            d_embed=d_embed, d_model=d_model, d_h=d_h, nlayers=nlayers, out_dim=d_out,
            vocab_size=vocab_size, seq_len=seq_len, use_gcn=use_gcn,
